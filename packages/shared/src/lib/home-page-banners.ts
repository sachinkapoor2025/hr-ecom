...
export const RAKSHA_BANDHAN_ORDER_BY_20_BANNER_ALT =
  "Raksha Bandhan — Standard USA delivery · 5 business days · Free shipping on $15 minimum | UsaRakhi" as const;
...
export const LAST_MINUTE_RAKHI_ORDERS_BANNER_ALT =
  "Standard USA delivery · 5 business days · Free shipping on $15 min | UsaRakhi" as const;
