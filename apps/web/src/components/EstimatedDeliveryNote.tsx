...
export function EstimatedDeliveryNote({
  ...
  const rakhiBullets = [
    `~${RAKHI_ON_TIME_DELIVERY_SUCCESS_PERCENT}% chance of Rakhi-day delivery (${notice.festivalShort}) when you order by ${notice.orderByShort} with 3-day or 2-day shipping`,
