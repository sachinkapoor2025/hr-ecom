/**
 * Floor UsaRakhi product prices at $20 (Orange County skipped).
 *
 *   ENVIRONMENT=prod npx tsx scripts/floor-rakhi-prices-to-20.ts
 *   DRY_RUN=1 ENVIRONMENT=prod npx tsx scripts/floor-rakhi-prices-to-20.ts
 *
...
const MIN_PRICE_USD = 20;
const IDEMPOTENCY_TAG = "price-floor-2026-08-24-min20";
